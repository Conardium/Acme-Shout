...
<body>
	<form:form modelAttribute="tarjeta" method="post"
		...
		<table>
			<!-- Campos Tarjeta -->
			<tr>
				<td><form:label path="marca"><spring:message code="edit.creditcard.1" /></form:label></td>
			...
			<tr>
				<td><form:label path="numero"><spring:message code="edit.creditcard.2" /></form:label></td>
			...
			<tr>
				<td><form:label path="mes"><spring:message code="edit.creditcard.3" /></form:label></td>
				<td><form:input path="mes" type="number" min="1"
						max="12" required="required" /></td>
				<td><form:errors path="mes" cssClass="error" /></td>
			</tr>
			<tr>
				<td><form:label path="anio"><spring:message code="edit.creditcard.4" /></form:label></td>
				<td><form:input path="anio" type="number"
						min="2024" required="required" /></td>
				<td><form:errors path="anio" cssClass="error" /></td>
			</tr>
			<tr>
				<td><form:label path="codigoCVV"><spring:message code="edit.creditcard.5" /></form:label></td>
			...
			<tr>
				<td colspan="3"><input type="submit" value=<spring:message code="edit.creditcard.6" /> /></td>
			</tr>
		</table>
	</form:form>
<button type="button" onclick="goBack()"><spring:message code="edit.creditcard.7" /></button>
</body>
</html>