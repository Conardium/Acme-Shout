...
<body>
    ...
    <table>
        ...
        <tr>
            <td><form:label path="descripcion"><spring:message code="create.edit.tutorial.value.2" /></form:label></td>
        ...
        <tr>
            <td colspan="3"><input type="submit" value=<spring:message code="create.edit.tutorial.value.4" /> /></td>
        </tr>
    </table>
</form:form>
