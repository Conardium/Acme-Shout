...
<html>
<head>
<title><spring:message code="createdit.actor.15" /></title>
</head>
<body>
	...
	<form:form modelAttribute="alumno" method="post"
		...
		<table>
			<!-- Campos Actor -->
			<tr>
				<td><form:label path="nombre"><spring:message code="createdit.actor.9" /></form:label></td>
				<td><form:input path="nombre" /></td>
				<td><form:errors path="nombre" cssClass="error" /></td>
			</tr>
			<tr>
				<td><form:label path="apellidos"><spring:message code="createdit.actor.10" /></form:label></td>
				<td><form:input path="apellidos" /></td>
				<td><form:errors path="apellidos" cssClass="error" /></td>
			</tr>
			<tr>
				<td><form:label path="correo"><spring:message code="createdit.actor.11" /></form:label></td>
			...
			<tr>
				<td><form:label path="telefono"><spring:message code="createdit.actor.12" /></form:label></td>
			...
			<tr>
				<td><form:label path="direccionPostal"><spring:message code="createdit.actor.13" /></form:label></td>
			...
			<tr>
				<td><form:label path="tarjetaCredito.numero"><spring:message code="createdit.actor.21" /></form:label></td>
			...
			<!-- Marca -->
			<tr>
				<td><form:label path="tarjetaCredito.marca"><spring:message code="createdit.actor.22" /></form:label></td>
			...
			<!-- Mes de Expiración -->
			<tr>
				<td><form:label path="tarjetaCredito.mes"><spring:message code="createdit.actor.23" /></form:label></td>
			...
			<!-- Año de Expiración -->
			<tr>
				<td><form:label path="tarjetaCredito.anio"><spring:message code="createdit.actor.24" /></form:label></td>
			...
			<!-- CVV -->
			<tr>
				<td><form:label path="tarjetaCredito.codigoCVV"><spring:message code="createdit.actor.25" /></form:label></td>
			...
			<tr>
				<td colspan="3"><input type="submit" value=<spring:message code="createdit.actor.18" /> />
					<button type="button" onclick="goBack()"><spring:message code="createdit.actor.16" /></button></td>
			</tr>
		</table>
	</form:form>
</body>
