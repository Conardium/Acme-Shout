		...
		<table>
			...
			<tr>
				<td><form:label path="nombre">
						<spring:message code="create.style.1" />
					</form:label></td>
			...
			<tr>
				<td><form:label path="descripcion">
						<spring:message code="create.style.2" />
					</form:label></td>
			...
			<!-- Campo Imágenes -->
			<tr>
				<td><form:label path="imagenes">
						<spring:message code="create.style.3" />
					</form:label></td>
			...
			<!-- Campo Videos -->
			<tr>
				<td><form:label path="videos">
						<spring:message code="create.style.4" />
					</form:label></td>
			...
			<tr>
				<td colspan="3"><input type="submit"
					value=<spring:message code="create.style.7" /> /></td>
			</tr>
			<!-- Botón de volver -->
			<tr>
				<td colspan="3">
					<button type="button" onclick="goBack()">
						<spring:message code="create.style.6" />
					</button>
				</td>
			</tr>
		</table>
